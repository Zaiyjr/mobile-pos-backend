...
export class StockService {
  ...
  addIMEI(data: { variantId: number; serialNumber: string; status?: string }) { return this.repo.add(data); }
  ...
  updateStatus(id: number, status: string) { return this.repo.updateStatus(id, status); }
}
