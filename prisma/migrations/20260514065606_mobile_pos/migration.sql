...
-- AddForeignKey
ALTER TABLE `ProductSpec` ADD CONSTRAINT `ProductSpec_attributeId_fkey` FOREIGN KEY (`attributeId`) REFERENCES `SpecAttribute`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
